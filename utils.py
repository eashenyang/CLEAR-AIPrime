...
def save_model(args, epoch, model, model_without_ddp, optimizer, loss_scaler, model_ema=None, trial=None):
    output_dir = Path(args.output_dir)
    epoch_name = str(epoch)
    checkpoint_paths = [output_dir / ('checkpoint-{}-trial{}.pth'.format(epoch_name, trial))]
    ...
    if is_main_process() and isinstance(epoch, int):
        ...
        old_ckpt = output_dir / ('checkpoint-{}-trial{}.pth'.format(to_del, trial))
