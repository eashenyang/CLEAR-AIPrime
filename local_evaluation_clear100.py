...
from evaluation_utils.CLEAR100 import CLEAR100IMG
from torch.utils.data import DataLoader

# Import participant's prediction class
from evaluation_setup_clear100 import load_models, data_transform
...
class CLEARPredictor(BaseCLEARPredictor):
    ...
    def prediction(self, image_file_path: str):
        ...
        test_data = [CLEAR100IMG(image_file_path, i, form="all", debug=False, transform=transform) for i in range(self.bucket_num)]
...
def main():
    ...
    parser.add_argument(
        "--dataset-path",
        default='/home/jiawei.dong/projects/CVPR_Challenge_2022/CLEAR/clear_test/test_data',
        # required=True,
        dest="dataset_path",
